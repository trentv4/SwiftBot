...
retortData = {
	"wuteat": ["Eat a dick.", "Penis.", "Gyros.", "Filet Mignon.", "Steak.", "Eat shit and die.", "My ass.", "Kebab.", "Borscht.", "Italian.", "Happy Meal.", "Less, fatty.", "You didn't pack your own lunch?  I'm not your fucking mother.", "Stir fry.", "MONGORIAN", "Sushi.", "Casey's taco pizza.", "Home Depot hotdog.", "An entire fucking can of beans.", "Chicken noodle soup.", "Potato soup.", "Baked potato.", "Chik-Fil-A.", "Jesus Chicken.", "Chipotle.", "Taco Bell.", "Five Guys.", "Crème fraîche.", "A nice goat-cheese and hierloom tomato frittata, topped with a little crème fraîche.", "Pan-roasted chicken.", "A potato-encrusted scallop with lobster foam topped with some crème fraîche.", "Asian slaw on flat bread, deconstructed and topped with a nice Parmesan aioli.", "Baked ziti with basil and fresh mozzarella.", "Corndog.", "Candied apple.", "Tide pods.", "Crayons.", "A shitload of olives.", "Escargot.", "Deli lunch meat sandwich.", "Kentucky Friend Chicken.", "Jell-O pudding cups.", "Space cakes.", "Edibles.", "Skittles.", "Turkey meat Lunchables.", "Scooby-Snacks fruit snacks.", "Froot-By-The-Foot."],
	"wutdrink": ["Unholy Trinity (1/2 Vodka, 1/2 Everclear, 1/2 Absinthe)", "Diet water, you grotesque fuck.", "High quality H2O.", "White wine.", "Red wine.", "Bong water.", "Moonshine.", "Mike's Hard lemonade, you pansy ass.", "Mike's Harder lemonade, you slightly less pansy ass.", "Vodka.", "Kvass.", "V8 fruit juice.", "Bleach.", "Gamer girl bath water.", "Antifreeze.", "An entire bottle of NyQuil.", "Hot dog water.", "Beer.", "Naturdays.", "White Claw.", "Wild Turkey.", "Majitos.  ", "Cletus' backwoods moonshine.", "Jägerbombs.", "Red Bull and Windex 50/50.", "Lemonade.", "Coca-Cola.", "Pepsi.", "Dr. Thunder.", "HeeHaw.", "MTN DEW® AMP® GAME FUEL®", "Everclear.", "Bourbon.", "Gin and juice.", "Riot juice.", "Jungle juice.", "Old Fashioned.", "FireClean Weapons Oil.", "Squirt.", "Mexican pineapple soda.", "Lester's Fixins ranch dressing soda.  (You fucking won't, pussy.)", "Prison wine.", "Soviet-style fermented BMP Door Drank™.", "Samogon.", "Ginger Ale.", "Sake.", "Breast milk.", "Brotein.", "Mojito.", "Long Island Ice Tea.", "Arizona Ice Tea.", "Cherry Limeade.", "Grape drank.", "Martini.", "Fearless redneck.", "Apocalypse now.", "Toilet water.", "Dick sucker.", "Dirty red-headed slut.", "Blow job.", "Jell-O shots.", "UV Blue."],
	"howfuck": ["Definitely anal.", "Anal?  Anal.", "Shut the fuck up, virgin.", "succ", "Fellatio.", "Cunnilingus.", "Analingus.", "Brojob (no homo).", "You shouldn't be having sex until after marriage, …ary position for the sole purpose of procreation.", "Doggy.", "Army style.", "Cowgirl.", "Reverse cowgirl.", "Amazon position.", "Alaskan pipeline.", "Make an angry dragon.", "Balls deep.  Literally put the balls inside there along with the penis.", "Buttstuff, but just the tip to see how it feels.", "Tittyfuck.", "Don't kid yourself.  We both know you're just going to masturbate by yourself again.", "Sixty-nine.", "Tonight's the night you try pegging.", "Slow missionary with uninterrupted, prolonged eye contact.", "Hotdog windshield wiper.", "Sad, disinterested handjob.", "Paint their face.", "Ten dollars gets you everything you want.", "You need another fix?  Fuck off, dopie.", "As if anyone would fuck you.", "Fountain of youth.", "Tongue-punch the fartbox.", "Dutch rudder.", "ICE/migrant child roleplay.", "A good ol' fashioned dick sucking.", "Suck on them toes.", "Shake them titties, pop that pussy, let me see that doo-doo brown.", "Dog + peanut butter.", "Do that one thing where you strap yourself in and …after you've died and pissed and shit everywhere.", "Make a DIY gloryhole and see what happens.", "Over-the-pants handjob.", "Bring in the gimp.", "How fuck?  For five seconds like always.", "Goatse tribute.", "Ha!  www.pornhub.com - You're not breaking the cycle tonight.", "You should be denying others your essence so as to…eserve the purity of your precious bodily fluids."],
	"wherefuck": ["In a classroom.", "In the bedroom.", "In a sidecar motorcycle.", "In a hotel.", "In the pool.", "In a treehouse.", "In a childrens' park.", "In the rehab parking lot.", "In an ambulance.", "In an airplane.", "In your dreams.", "In a porta-shitter.", "In the handicap stall.  Fuck cripples.", "In the backseat of your car.", "In the front seat of your car.", "In the woods, raw dogging, just like nature intended.", "In your recliner.", "At the airport terminal.", "At the police station.", "In your cousin's bathroom at your niece's bat mitzvah.", "On the couch at your psych eval.", "On the kitchen table.", "On your desk.", "On the couch.", "Right here, right now.  Dick out, pants off.", "In the shower.", "On a balcony.", "Against the wall.", "In a foxhole you dug the night before after callin… 344-7483 with your battle buddy (secretly homo).", "At my next concert.", "At a house party.", "In a dorm room.", "On a football field.", "In a cornfield.  Watch out for @Jonsie.", "In the rice fields, motherfucker.", "At your doctor's office.", "At the DMV.", "At the family reunion where you just met."],
	"Why you gotta be so mean?": ["Because you're a fucking faggot.", "Because fuck you, that's why.", "Go fuck yourself.", "Because you touch yourself at night.", "We all get why your dad never came back from getting cigarettes now.", "Don't make me get my lawyers involved.", "Fuck off, retard.", "Like, what the fuck did you just fucking say about…re never, ever ever getting back together, kiddo.", "You're a liar and pathetic.", "If a man talks shit, then I owe him nothing.", "You said I was obsessive and crazy.", "Your dog didn't run away, it killed itself.", "Grandma went into the nursing home specifically because she knew you'd never visit.", "I bet you could suck ten dicks in two minutes.", "I will end you.", "They're pity-fucking you and feel trapped because they think you'll kill yourself if they leave.", "You were dropped as a child.", "#metoo", "You look like a bitch.", "You're why we can't have nice things.", "One can only hope you have evidence leading to the… won't have to put up with your shit much longer.", "You're the person people tell their kids they'll end up like if they don't go to school.", "If I had a terminal illness and the entire Avenger…ind a way to give you whatever it was that I had.", "Do you suck dicks?", "You ever get that suspicion people are only nice t…se they think you're retarded?  You're not wrong."]
}
...
retortCommands = {
	...
	"=wutmeal": {
		whitelist: GENERAL_WHITELIST,
		text: "%wuteat% with some %wutdrink% to wash it down"
	},
	"=nightin": {
		whitelist: GENERAL_WHITELIST,
	...
	"=datenight": {
		whitelist: GENERAL_WHITELIST,
		text: "Try %wuteat% with some %wutdrink% to wash it down. Then later, some %howfuck% %wherefuck%"
	},
	"Why you gotta be so mean?": {
		whitelist: GENERAL_WHITELIST,
